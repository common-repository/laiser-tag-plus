...
ltpoc.SocialTag = ltpoc.TagSource.extend({
	...
	getTagText: function() {
		...
		if (ltpoc.artifactManager.artifactDisplayInfo.docCatDisplayText[this.name]) {
			return ltpoc.artifactManager.artifactDisplayInfo.docCatDisplayText[this.name];
		}
		return this.name;
	},
