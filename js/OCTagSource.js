...
ltpoc.TagSource = CFBase.extend({
	init: function(rdfDescription) {
		...
		this.type = rdfDescription.type ? ltpoc.artifactManager.createArtifactTypeIfNew(rdfDescription.type[0]['rdf:resource']) : null;
	...
	wasRehydrated: function() {
		...
		this.type = ltpoc.artifactManager.createArtifactTypeIfNew(this.type.url);
	},
