...
ltpoc.FlickrImage = ltpoc.Image.extend({
	...
	getLicenseIconURL: function() {
		return ltpoc.imageManager.ccLicenseIconMap[this.flickrObj.license];
	},
	
	_cacheLicenseInfo: function() {
		if (ltpoc.imageManager.flickrLicenseInfo.stat === 'ok') {
			var poppet = this;
			var x = jQuery.grep(ltpoc.imageManager.flickrLicenseInfo.licenses.license, function(obj) {
